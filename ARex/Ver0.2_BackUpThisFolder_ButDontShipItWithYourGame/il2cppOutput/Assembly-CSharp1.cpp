...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GeospatialController_OnSetAnchorClicked_m8470510D1E0D3E09FA8A9CE037B816533158843D (GeospatialController_t69A2BBD44F5A190BB256B888033F5297AF0A0D2F* __this, const RuntimeMethod* method) 
{
	...
	bool V_4 = false;
	{
		...
		V_3 = L_13;
		// if (anchor != null)
		ARGeospatialAnchor_tD63E18E1D193A2B24B757D285F3CF67A8FC7F571* L_14 = V_3;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_15;
	...
	}
	{
		...
		GeospatialAnchorHistoryCollection_tE5EDB6915BC64A3689D5063C0AE9BDCDBDEB2BBD* L_17 = __this->____historyCollection_45;
		NullCheck(L_17);
		...
		NullCheck(L_18);
		List_1_Add_m14F14B1A2F8E0A0240A5BE0A6DEED701683CA179_inline(L_18, L_19, List_1_Add_m14F14B1A2F8E0A0240A5BE0A6DEED701683CA179_RuntimeMethod_var);
	}

IL_005d:
	{
		// ClearAllButton.gameObject.SetActive(_anchorObjects.Count > 0);
		Button_t6786514A57F7AFDEE5431112FEA0CAB24F5AE098* L_20 = __this->___ClearAllButton_15;
		NullCheck(L_20);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_21;
		L_21 = Component_get_gameObject_m57AEFBB14DB39EC476F740BA000E170355DE691B(L_20, NULL);
		List_1_tB951CE80B58D1BF9650862451D8DAD8C231F207B* L_22 = __this->____anchorObjects_46;
		NullCheck(L_22);
		int32_t L_23;
...
IL_0197:
	...
	}
	{
		...
		L_38 = Input_get_location_m1D1FA0938E5B83C46A666CE78D95A58B39164DB5(NULL);
		NullCheck(L_38);
		int32_t L_39;
...
IL_03e8:
	...
	}
	{
		...
		L_94 = Input_GetTouch_m75D99FE801A94279874FA8DC6B6ADAD35F5123B1(0, NULL);
		V_28 = L_94;
		int32_t L_95;
	...
	}
	{
		...
		L_96 = EventSystem_get_current_mC87C69FB418563DC2A571A10E2F9DB59A6785016(NULL);
		Touch_t03E51455ED508492B3F278903A0114FA0E87B417 L_97;
		L_97 = Input_GetTouch_m75D99FE801A94279874FA8DC6B6ADAD35F5123B1(0, NULL);
		V_28 = L_97;
		int32_t L_98;
...
IL_043e:
	...
	}
	{
		...
		String_t* L_109;
		L_109 = Environment_get_NewLine_m8BF68A4EFDAFFB66500984CE779629811BA98FFF(NULL);
		NullCheck(L_108);
		...
		String_t* L_131;
		L_131 = String_Format_m918500C1EFB475181349A79989BB79BB36102894(_stringLiteral53DECEA44E2F813BD2CDB9161208758884B4FA95, L_128, NULL);
		NullCheck(L_106);
...
IL_0054:
	{
		...
		L_26 = ARAnchorManagerExtensions_ResolveAnchorOnTerrain_mFB8A8E939F146EA51A5FB24086DF91F1C6795AFF(L_20, L_22, L_24, (0.0), L_25, NULL);
		G_B5_0 = L_26;
	}
...
IL_00e9:
	{
		...
		String_t* L_55;
		L_55 = String_Format_mA8DBB4C2516B9723C5A41E6CB1E2FAF4BBE96DD8(_stringLiteral78E274AC89F9BB2B7C9C9C38754AE07662487DED, L_54, NULL);
		NullCheck(L_50);
...
IL_012f:
	{
		String_t* L_58;
		L_58 = String_Format_mA8DBB4C2516B9723C5A41E6CB1E2FAF4BBE96DD8(G_B16_1, G_B16_0, NULL);
		NullCheck(G_B16_2);
...
IL_00d6:
	...
	}
	{
		...
		String_t* L_28;
		L_28 = String_Format_m918500C1EFB475181349A79989BB79BB36102894(_stringLiteral80D85E354963DC5787AAB3990BB9B8D1D718AD91, L_27, NULL);
		V_1 = L_28;
	}
